...
@section('menuCSS','css/menu/menu.css?v='.cache("js_version_number").'')
    -->
@section('menuActive','UAIRLogaritmo')
                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class="subheader-icon fal fa-crosshairs"></i> {{$title}}
                            <small>
                            </small>
                        </h1>
                                                ...
                                                <div class="position-relative">
                                                  <div class="container">
                                                      ...
                                                      <form class="form-inline">
                                                            ...
                                                            <button type="button" class="btn buttons-print btn-outline-default" onclick="logaritmo()">Enviar</button>
                                                        </form>
