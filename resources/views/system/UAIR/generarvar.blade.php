...
@section('title'){{'Generar Var'}}@stop
                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class="subheader-icon fal fa-upload"></i> Generar Var
                            <small>
                            </small>
                        </h1>
                    </div>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-12 col-xl-12">
                                                <div class="position-relative">
                                                        ...
                                                        <button onclick="generarVar()" class="btn buttons-print btn-outline-default waves-effect waves-themed">Iniciar proceso de generar Var</button>
