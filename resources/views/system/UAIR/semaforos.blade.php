...
@section('menuCSS','css/menu/menu.css?v='.cache("js_version_number").'')
    -->
@section('menuActive','UAIRAsemaforos')

@section('raiz1', @Config::get('app.name'))
@section('raiz1Url', '/inicio')
@section('raiz2','Perfil')
@section('raiz2Url','/perfil')


{{-- Angular Controller --}}

@section('controller','semaforos')
                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class="subheader-icon fal fa-life-ring"></i> {{$title}}
                            <small>
                            </small>
                        </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 sortable-grid ui-sortable">
                            ...
                            <div id="panel-1" class="panel panel-locked panel-sortable" data-panel-lock="false" data-panel-close="false" data-panel-fullscreen="false" data-panel-collapsed="false" data-panel-color="false" data-panel-locked="true" data-panel-refresh="false" data-panel-reset="false" role="widget">
                                ...
                                <div class="panel-hdr">
                                    <h2 class="ui-sortable-handle">
                                        <!--<a class="btn btn-primary btn-xs" onclick="showChart('graficaSemaforo', 'btnShowGraficaSemaforo')"
                                        id="btnShowGraficaSemaforoAntes" style="color: white; display: block;">Mostrar Grafica</a>-->
                                    ...
                                    <div class="panel-content border-faded border-left-0 border-right-0 border-top-0">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-12 col-xl-12">
                                                ...
                                                <canvas id="graficaSemaforoUsuario" style="display:none" ></canvas>
                                ...
                                <div class="panel-container show" role="content">
                                    <div class="panel-content border-faded border-left-0 border-right-0 border-top-0">
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-12 col-xl-12">
                                                <div class="position-relative">
                                                <div id="conteTableSemaforoVarLimite"></div>

                        
                                                <canvas id="graficaSemaforoVarLimite" style="display:none" ></canvas>
                            ...
                            <div id="panel-1" class="panel panel-locked panel-sortable" data-panel-lock="false" data-panel-close="false" data-panel-fullscreen="false" data-panel-collapsed="false" data-panel-color="false" data-panel-locked="true" data-panel-refresh="false" data-panel-reset="false" role="widget">
                                ...
                                <div class="panel-hdr">
                                    <h2 class="ui-sortable-handle">
                                      ...
                                      <!--<a class="btn btn-primary btn-xs" onclick="showChart('graficaSemaforoOperaciones', 'btnShowGraficaSemaforoOperaciones')"
                                        id="btnShowGraficaSemaforoOperaciones" style="color: white; display: bloxk;">Mostrar Grafica</a>-->
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-12 col-xl-12">
                                                ...
                                                <div id="conteTableSemaforoOperaciones"></div>
                                                    ...
                                                    <canvas id="graficaSemaforoOperaciones"  style="display:none" ></canvas>
