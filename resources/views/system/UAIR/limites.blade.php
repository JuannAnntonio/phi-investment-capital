...
@section('menuCSS','css/menu/menu.css?v='.cache("js_version_number").'')
    -->
@section('menuActive','UAIRAsignacionLimites')
                ...
                <main id="js-page-content" role="main" class="page-content">
                    ...
                    <div class="subheader">
                       ...
                       <!-- <a class="btn buttons-print btn-outline-default" onclick='add()'
                        ...
                        <select id="selectTipo" class="form-control" style="width: 25%; display: inline-table; margin-left: 5px;" >
                           <option value="contraparte">Contraparte</option>
                            <option value="operador">Operador</option>
                       </select>
                       
                        <select id="selectDivisas" class="form-control" style="width: 25%; display: inline-table; margin-left: 5px;" >
                    ...
                    <div class="row">
                        ...
                        <select class="selectCustom" id="selectTipo" class="form-control" style="width: 200px; display: inline-table; margin-left: 5px;" >
                         ...
                         <br>
                                                   ...
                                                   <div id="add" style="width: 100%; height:250px; display:none"  >
                                                        <div >
                                                            <br>
                                                            <br>
