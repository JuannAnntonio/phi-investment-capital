...
<div class="page-wrapper">
                    ...
                    <main id="js-page-content" role="main" class="page-content">
                        ...
                        <div class="subheader">
                            <h1 class="subheader-title">
                                <i class="subheader-icon fal fa-chart-area"></i> Registro de Operaciones Directo
                                <small>
                                </small>
                            </h1>
                        </div>
                            ...
                            <div class="col-lg-12 sortable-grid ui-sortable">
                                <div id="panel-4" class="panel data-panel-sortable" data-panel-lock="false" data-panel-close="false" data-panel-fullscreen="false" data-panel-collapsed="false" data-panel-color="false" data-panel-locked="true" data-panel-refresh="false" data-panel-reset="false" role="widget">
                                    <div class="panel-hdr" role="heading">
                                        <h2>
                                            Registro de Operaciones Directo  <span style="padding-left: 5px;" id="mesActual"></span>
                                        </h2>
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div style="margin-top: 30px;" class="col-md-6">
                                                    ...
                                                    <label style="margin-left: 5px;">Fecha de Operación:</label>
                                                ...
                                                <div style="margin-top: 30px;" class="col-md-6">
                                                    ...
                                                    <label style="margin-left: 5px;">Tipo de Operación:</label>
                                                    <div style="margin-top: 10px;" class="input-group">
                                                        
                                                        <select class="select2 form-control w-100" id="operacion">
                                                            <option value="default">Selecciona un Tipo de Operción</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div style="margin-top: 30px;" class="col-md-6">
                                                    ...
                                                    <label style="margin-left: 5px;">Instrumento:</label>

                                                    <select class="select2 form-control w-100" id="instrumento">
                                                        <option value="default">Selecciona un Instrumento</option>
                                                        <option ng-repeat="(key, instrumento) in instrumentos" value="<% instrumento.issue %>"><% instrumento.issue %></option>
                                                    </select>
                                                ...
                                                <div style="margin-top: 30px;" class="col-md-6">
                                                    ...
                                                    <label style="margin-left: 5px;">Monto Nominal:</label>

                                                    <input type="text" data-inputmask="'alias': 'currency2'" class="form-control" id="montoNominal" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div style="margin-top: 30px;" class="col-md-6">
                                                    ...
                                                    <label style="margin-left: 5px;">Número de Títulos:</label>

                                                    <input readonly="true" data-inputmask="'alias': 'currency2'" type="text" class="form-control" id="numeroDeTitulos" />

                                                </div>

                                                <div style="margin-top: 30px;" class="col-md-6">

                                                    <label style="margin-left: 5px;">Tasa/Sobretasa:</label>

                                                    <input type="text" data-inputmask="'alias': 'currency2'" class="form-control" id="tasaSobreTasa" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div style="margin-top: 30px;" class="col-md-6">
                                                    ...
                                                    <label style="margin-left: 5px;">Precio:</label>

                                                    <input type="text" data-inputmask="'alias': 'currency2'" class="form-control" id="precio" />

                                                </div>

                                                <div style="margin-top: 30px;" class="col-md-6">

                                                    <label style="margin-left: 5px;">Monto Liquidación:</label>

                                                    <input readonly="true" type="text" data-inputmask="'alias': 'currency2'" onkeydown="javascript: return event.keyCode == 69 ? false : true" class="form-control" id="montoLiquidacion" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div style="margin-top: 30px;" class="col-md-6">
                                                    ...
                                                    <label style="margin-left: 5px;">Fecha Liquidación:</label>
                                                    <div style="margin-top: 0px;" class="input-group">
                                                        
                                                        <select class="select2 form-control w-100" id="fechaLiquidacion">
                                                            <option value="default">Selecciona una Fecha de Liquidación</option>
                                                ...
                                                <div style="margin-top: 30px;" class="col-md-6">
                                                    ...
                                                    <label style="margin-left: 5px;">Contraparte:</label>

                                                    <input type="text" class="form-control" id="contraparte" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 text-center">
                                                    <button ng-click="guardar()" style="margin-top: 25px;" class="btn btn-primary btn-sm waves-effect waves-themed text-center">
                                                        Guardar
                                                    </button>
                                                </div>
        ...
        <script src="{{ url('js/vendors.bundle.js?v='.cache("js_version_number").'') }}" charset="utf-8"></script>
        <script src="{{ url('js/app.bundle.js?v='.cache("js_version_number").'') }}" charset="utf-8"></script>
        ...
        <script src="{{ url('js/flot.bundle.js?v='.cache("js_version_number").'') }}"></script>
        ...
        <script>
            $(document).ready(function()
            {
                ...
                $('#montoNominal').on('change', function() {

                    $('#numeroDeTitulos').val(numberWithCommas(parseInt(replaceComasInNumbers("montoNominal")/100)));

                    if($('#precio').val()!=""){
                        $('#montoLiquidacion').val(numberWithCommas(parseFloat(replaceComasInNumbers("numeroDeTitulos"))*parseFloat(replaceComasInNumbers("precio"))));
                    }
                });

                $('#precio').on('change', function() {
                    if($('#numeroDeTitulos').val()!=""){
                        $('#montoLiquidacion').val(numberWithCommas(parseFloat(replaceComasInNumbers("numeroDeTitulos"))*parseFloat(replaceComasInNumbers("precio"))));
                    }
                });
        ...
        <script>
            $(document).ready(function()
            {
                ...
                $("#montoNominal").inputmask();
                $("#precio").inputmask();
                $('#tasaSobreTasa').inputmask();
                ...
                */
                ...
                $("#datepicker-2").prop('disabled', true);
