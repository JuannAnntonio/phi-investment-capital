<footer class="page-footer" role="contentinfo">
                        <div class="d-flex align-items-center flex-1 text-muted">
                            <span class="hidden-md-down fw-700">2019 © {{ Config::get('app.name') }} by&nbsp;<a href="https://www.boogapp.mx" class="text-primary fw-500" title="boogapp.mx" target="_blank">boogapp.mx</a></span>
                        </div>
                        <div>
