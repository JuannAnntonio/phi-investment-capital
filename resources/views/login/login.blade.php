              ...
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  <div class="col-md-8 resaltar">
                    ...
                    <p class="resaltar">Bienvenido al Sistema Integral de Riesgos. Por favor ingrese su usuario y contraseña</p>
                    ...
                    <a style="margin-bottom: 40px;" href="#">
                      <p class="resaltar"><a href="{{ url('/recuperar') }}">¿Olvidaste tu Contraseña?</a></p>
                    </a>
                    -->
